...
class TestBackupProcessor(unittest.TestCase):
    ...
    def test_apps_to_backup(self):
        ...
        test_cases = [
            ...
            SubtestCase(name='mysql-innodb excluded',
    ...
    def test_process_backups_backup_controller(self, mock_controller_processor_class: Mock,
                                               mock_connect_controller: Mock):
        controller_list = ['controller1', 'controller2']
        self.mock_config.all_controllers = False
        self.mock_config.use_current_controller = False
    ...
    @patch('jujubackupall.process.connect_controller')
    @patch('jujubackupall.process.ControllerProcessor')
    def test_process_backups_no_backup_controller(self, mock_controller_processor_class: Mock,
                                                mock_connect_controller: Mock):
        controller_list = ['controller1', 'controller2']
        self.mock_config.all_controllers = False
        self.mock_config.use_current_controller = False
...
class TestControllerProcessor(unittest.TestCase):
    ...
    def test_backup_apps_all_supported(self, mock_get_backup_instance: Mock,
        ...
        calls_get_backup_instance = [call(charm_name='mysql-innodb-cluster', unit=ANY),
